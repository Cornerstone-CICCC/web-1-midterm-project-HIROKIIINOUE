export const ownProjectScriptEn = [
	{
		id: 1,
...
export const ownProjectScriptJp = [
	{
		id: 1,
		title: "trip calculator",
		image: "/tripcalculator.png",
		content:
			"海外旅行用の予算、出費を計算してくれるWebアプリの開発。異なる通貨レートの計算をタイムリーに実現可能。技術スタックは React.js, TypeScript, TailwindCSS, Firebase.",
	},
	{
		id: 2,
		title: "portfolio",
		image: "/portfolio.png",
		content:
			"現在見ていただいている自己紹介用のポートフォリオ。技術スタックは Next.js, TypeScript, SASS.",
	},
];
